    ...
    <main class="container">
		...
		<ul class="caption-style-2">
            ...
            if($Country != "0" & $Continent != "0"){
                $result = mysqli_query($db, "SELECT * FROM ImageDetails WHERE ContinentCode='$Continent' AND CountryCodeISO='$Country'");

            }
            else{
                if($Continent != "0" ) {
                    $result = mysqli_query($db, "SELECT * FROM ImageDetails WHERE ContinentCode='$Continent'");
                    loop($result);
                }
                if($Country != "0" ){
                    $result = mysqli_query($db, "SELECT * FROM ImageDetails WHERE CountryCodeISO='$Country'");
                    loop($result);
                }
                if($Country == "0" && $Continent == "0"){
                    $result = mysqli_query($db, "SELECT * FROM ImageDetails WHERE ImageID!='0'");
                    loop($result);
                }
            }
